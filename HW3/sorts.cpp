	...
	*/
      ...
      // destruction time.
    {
     vector<Sensor> auxSensors(sensors);
      ...
      for (size_t i = 0; i < sensorPointers.size(); i++) {
          sensors[i] = *sensorPointers[i];
      }
