...
{
    m_age++;
    m_arena -> thePrevious().dropACrumb(m_row, m_col); //When player stands drop a crumb to increment letter 
}
...
void Player::move(int dir)
{
    ...
    m_arena -> thePrevious().dropACrumb(m_row, m_col); //After player finishes moving (aka the m_row and m_col are updated) drop a crumb to increment letter
}

bool Player::shoot(int dir)
{
    m_age++;
    m_arena -> thePrevious().dropACrumb(m_row, m_col); //When player shoots drop a crumb to increment letter
