...
public:
    ...
    WeddingGuest (const WeddingGuest& other); //copy constructor

    WeddingGuest& operator=(const WeddingGuest& other); //assignment operator

    bool noGuests() const; // Return true if the WeddingGuest list // is empty, otherwise false.

    int guestCount() const; // Return the number of matches // on the WeddingGuest list.
